...
public class CollegeMonthCS implements Writable, DBWritable {
    ...
    public CollegeMonthCS(int college_id, int month, int year, int consumption_count, float consumption_total_money, float consumption_average_money, float consumption_student_average_money, int student_count) {
