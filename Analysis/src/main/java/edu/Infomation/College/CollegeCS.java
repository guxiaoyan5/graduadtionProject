...
public class CollegeCS implements Writable, DBWritable {
    ...
    public CollegeCS(int college_id, int consumption_count, float consumption_total_money, float consumption_average_money, float consumption_student_average_money, int student_count, int consumption_low_count, int consumption_high_count, int student_low_count, int student_high_count) {
    ...
    public void write(PreparedStatement preparedStatement) throws SQLException {
        ...
        preparedStatement.setInt(9,this.student_low_count);
        preparedStatement.setInt(10,this.student_high_count);
    }
    ...
    public void readFields(ResultSet resultSet) throws SQLException {
        ...
        this.student_low_count = resultSet.getInt(9);
        this.student_high_count = resultSet.getInt(10);
    }
}
