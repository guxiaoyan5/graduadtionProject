...
public class CollegeDayTCS implements Writable, DBWritable {
    ...
    public CollegeDayTCS(int college_id, String meal, Date day, int consumption_count, float consumption_total_money, float consumption_average_money, float consumption_student_average_money, int student_count, int consumption_low_count, int consumption_high_count, int student_low_count, int student_high_count) {
