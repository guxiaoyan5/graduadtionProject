...
public class MajorMonthTCS implements Writable, DBWritable {
    ...
    public MajorMonthTCS() {
    }

    public MajorMonthTCS(int major_id, ThreeMeals meal, int month, int year, int consumption_count, float consumption_total_money, float consumption_average_money, float consumption_student_average_money, int student_count, int consumption_low_count, int consumption_high_count, int student_low_count, int student_high_count) {
