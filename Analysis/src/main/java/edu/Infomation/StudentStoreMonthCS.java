...
public class StudentStoreMonthCS implements Writable, DBWritable {
    private String sid;
    ...
    public StudentStoreMonthCS() {
    }

    public StudentStoreMonthCS(String sid, int store_id, int month, int year, int consumption_count, float consumption_total_money, float consumption_average_money) {
        this.sid = sid;
