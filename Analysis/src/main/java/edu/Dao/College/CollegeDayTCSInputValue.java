...
public class CollegeDayTCSInputValue implements Writable, DBWritable {
    private String sid;
    ...
    public CollegeDayTCSInputValue() {
    }

    public CollegeDayTCSInputValue(String sid, int college_id, Date day, ThreeMeals meal, float money, float studentTotalMoney) {
        this.sid = sid;
    ...
    public String toString() {
        return "CollegeDayTCSInputValue{" +
                "sid='" + sid + '\'' +
