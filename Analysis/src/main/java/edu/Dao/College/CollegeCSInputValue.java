...
public class CollegeCSInputValue implements DBWritable, Writable {
    private String sid;
    ...
    public CollegeCSInputValue() {
    }

    public CollegeCSInputValue(String sid, int college_id, Date day, float money, float studentTotalMoney) {
        this.sid = sid;
