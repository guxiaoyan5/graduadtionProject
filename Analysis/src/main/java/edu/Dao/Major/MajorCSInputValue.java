...
public class MajorCSInputValue implements Writable, DBWritable {
    private String sid;
    ...
    public MajorCSInputValue() {
    }

    public MajorCSInputValue(String sid, int major_id, Date day, float money, float studentTotalMoney) {
        this.sid = sid;
