...
public class MajorMonthCSInputValue implements Writable, DBWritable {
    private String sid;
    ...
    public MajorMonthCSInputValue() {
    }

    public MajorMonthCSInputValue(String sid, int major_id, Date day, float money, float studentTotalMoney) {
        this.sid = sid;
