...
public class MajorDayTCSInputValue implements Writable, DBWritable {
    private String sid;
    ...
    public MajorDayTCSInputValue() {
    }

    public MajorDayTCSInputValue(String sid, int major_id, Date day, ThreeMeals meal, float money, float studentTotalMoney) {
        this.sid = sid;
