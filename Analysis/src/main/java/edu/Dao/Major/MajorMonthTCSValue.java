...
public class MajorMonthTCSValue implements Writable {
    private String sid;
    private float money;
    private float studentTotalMoney;

    public MajorMonthTCSValue() {
    }

    public MajorMonthTCSValue(String sid, float money, float studentTotalMoney) {
        this.sid = sid;
        this.money = money;
