...
public class MajorTCSInputValue implements Writable, DBWritable {
    private String sid;
    ...
    public MajorTCSInputValue() {
    }

    public MajorTCSInputValue(String sid, int major_id, Date day, ThreeMeals meal, float money, float studentTotalMoney) {
        this.sid = sid;
