...
public class MajorDayTCSValue implements Writable {
    private String sid;
    private float money;
    private float studentTotalMoney;

    public MajorDayTCSValue() {
    }

    public MajorDayTCSValue(String sid, float money, float studentTotalMoney) {
        this.sid = sid;
        this.money = money;
