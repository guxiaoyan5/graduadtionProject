...
public class ClassTCSValue implements Writable {
    private String sid;
    private float money;
    private float studentTotalMoney;

    public ClassTCSValue() {
    }

    public ClassTCSValue(String sid, float money, float studentTotalMoney) {
        this.sid = sid;
        this.money = money;
