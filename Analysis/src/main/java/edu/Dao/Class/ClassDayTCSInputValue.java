...
public class ClassDayTCSInputValue implements Writable, DBWritable {
    private String sid;
    ...
    public ClassDayTCSInputValue() {
    }

    public ClassDayTCSInputValue(String sid, int class_id, Date day, ThreeMeals meal, float money, float studentTotalMoney) {
        this.sid = sid;
