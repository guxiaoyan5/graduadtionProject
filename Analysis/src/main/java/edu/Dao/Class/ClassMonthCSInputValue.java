...
public class ClassMonthCSInputValue implements Writable, DBWritable {
    private String sid;
    ...
    public ClassMonthCSInputValue() {
    }

    public ClassMonthCSInputValue(String sid, int class_id, Date day, float money, float studentTotalMoney) {
        this.sid = sid;
    ...
    public String toString() {
        return "ClassMonthCSInputValue{" +
                ...
                ", day=" + day +
                ", money=" + money +
                ", studentAverageMoney=" + studentTotalMoney +
                '}';
    }
