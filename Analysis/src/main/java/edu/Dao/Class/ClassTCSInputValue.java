...
public class ClassTCSInputValue implements DBWritable, Writable {
    private String sid;
    ...
    public ClassTCSInputValue() {
    }

    public ClassTCSInputValue(String sid, int class_id, Date day, ThreeMeals meal, float money, float studentTotalMoney) {
        this.sid = sid;
