...
public class ClassMonthCSMiddleValue implements Writable {
    private String sid;
    private int consumption_count;
    private float consumption_total_money;

    public ClassMonthCSMiddleValue() {
    }

    public ClassMonthCSMiddleValue(String sid, int consumption_count, float consumption_total_money) {
        this.sid = sid;
