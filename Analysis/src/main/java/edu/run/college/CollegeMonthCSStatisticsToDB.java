...
public class CollegeMonthCSStatisticsToDB {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        DBInputFormat.setInput(job, CollegeMonthCSInputValue.class,
                "select student.id,college_id,execution_time,money,consumption_total_money from student,consume,student_month_consumption_statistics where student.id=consume.sid and student.id=student_month_consumption_statistics.sid and year(execution_time) = year and month(execution_time) = month",
