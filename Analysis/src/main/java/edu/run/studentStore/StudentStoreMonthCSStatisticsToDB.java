...
public class StudentStoreMonthCSStatisticsToDB {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        DBOutputFormat.setOutput(job, "student_store_month_statistics",
    ...
    private static class Map extends Mapper<Object, Consume, StudentStoreMonthCSKey, FloatWritable> {
        @Override
    ...
    private static class Reduce extends Reducer<StudentStoreMonthCSKey, FloatWritable, StudentStoreMonthCS, StudentStoreMonthCS> {
        @Override
