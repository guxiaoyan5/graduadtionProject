...
public class ConsumeThreeMonthData implements Serializable {
    ...
    public ConsumeThreeMonthData() {
    }

    public ConsumeThreeMonthData(String consumption_category, int month, int year, int consumption_count, float consumption_total_money, float consumption_average_money, float consumption_student_average_money, int student_count, int consumption_low_count, int consumption_high_count, int student_low_count, int student_high_count) {
