...
public class ConsumeThreeDayData implements Serializable {
    ...
    public ConsumeThreeDayData() {
    }

    public ConsumeThreeDayData(String consumption_category, Date date, int consumption_count, float consumption_total_money, float consumption_average_money, float consumption_student_average_money, int student_count, int consumption_low_count, int consumption_high_count, int student_low_count, int student_high_count) {
