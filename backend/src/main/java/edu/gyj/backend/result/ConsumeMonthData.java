...
public class ConsumeMonthData implements Serializable {
    private int month;
    private int year;
    ...
    public ConsumeMonthData() {
    }

    public ConsumeMonthData(int month, int year, int consumption_count, float consumption_total_money, float consumption_average_money, float consumption_student_average_money, int student_count, int consumption_low_count, int consumption_high_count, int student_low_count, int student_high_count) {
        this.month = month;
        this.year = year;
