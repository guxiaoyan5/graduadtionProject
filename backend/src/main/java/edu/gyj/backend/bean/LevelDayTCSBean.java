...
public class LevelDayTCSBean implements Serializable {
    ...
    public LevelDayTCSBean(int id, Date day, String name, String consumption_category, double consumption_total_money, double consumption_average_money, double max, double min, int count, int high, int low) {
        this.id = id;
        this.day = day;
        this.name = name;
