...
public class LevelDayCSBean implements Serializable {
    private int id;
    private Date day;
    private String name;
    ...
    public LevelDayCSBean() {
    }

    public LevelDayCSBean(int id, Date day, String name, double consumption_total_money, double consumption_average_money, double max, double min, int count, int high, int low) {
        this.id = id;
        this.day = day;
        this.name = name;
