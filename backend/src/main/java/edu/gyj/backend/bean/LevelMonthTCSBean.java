...
public class LevelMonthTCSBean implements Serializable {
    ...
    public LevelMonthTCSBean(int id, int year, int month, String name, String consumption_category, double consumption_total_money, double consumption_average_money, double max, double min, int count, int high, int low) {
        this.id = id;
        this.year = year;
        this.month = month;
        this.name = name;
