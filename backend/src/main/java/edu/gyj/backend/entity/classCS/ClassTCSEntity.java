...
public class ClassTCSEntity implements Serializable {
    ...
    public ClassTCSEntity() {
    }

    public ClassTCSEntity(int class_id, String name, String consumption_category, int consumption_count, float consumption_total_money, float consumption_average_money, float consumption_student_average_money, int student_count, int consumption_low_count, int consumption_high_count, int student_low_count, int student_high_count) {
