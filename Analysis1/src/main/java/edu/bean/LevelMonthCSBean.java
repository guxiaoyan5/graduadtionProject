...
public class LevelMonthCSBean implements Serializable {
    ...
    public LevelMonthCSBean(int id, int year, int month, double consumption_total_money, double consumption_average_money, double max, double min, int count, int high, int low) {
        this.id = id;
        this.year = year;
        this.month = month;
