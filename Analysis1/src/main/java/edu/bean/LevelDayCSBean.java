...
public class LevelDayCSBean implements Serializable {
    ...
    public LevelDayCSBean(int id, Date day, double consumption_total_money, double consumption_average_money, double max, double min, int count, int high, int low) {
        this.id = id;
        this.day = day;
