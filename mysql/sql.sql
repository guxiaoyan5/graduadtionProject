...
create table college_day_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    college_id                        int comment '学院',
    day                               date comment '日期',
...
create table college_month_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    college_id                        int comment '学院',
    month                             int comment '月份',
...
create table college_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    college_id                        int comment '学院',
    consumption_count                 int comment '消费次数',
...
create table college_day_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    college_id                        int comment '学院',
    day                               date comment '日期',
...
create table college_month_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    college_id                        int comment '学院',
    month                             int comment '月份',
...
create table college_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    college_id                        int comment '学院',
    consumption_category              enum ('早','午','晚'),
...
create table major_day_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    major_id                          int not null comment '专业',
    day                               date comment '日期',
...
create table major_month_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    major_id                          int not null comment '专业',
    month                             int comment '月份',
...
create table major_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    major_id                          int not null comment '专业',
    consumption_count                 int comment '消费次数',
...
create table major_day_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    major_id                          int comment '专业',
    consumption_category              enum ('早','午','晚'),
...
create table major_month_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    major_id                          int comment '专业',
    consumption_category              enum ('早','午','晚'),
...
create table major_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    major_id                          int comment '专业',
    consumption_category              enum ('早','午','晚'),
...
create table class_day_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    class_id                          int not null comment '班级',
    day                               date comment '日期',
...
create table class_month_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    class_id                          int not null comment '班级',
    month                             int comment '月份',
...
create table class_consumption_middle
(
    id                                int AUTO_INCREMENT primary key,
    class_id                          int not null comment '班级',
...
create table class_day_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    class_id                          int not null comment '班级',
    consumption_category              enum ('早','午','晚'),
...
create table class_month_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    class_id                          int not null comment '班级',
    consumption_category              enum ('早','午','晚'),
...
create table class_three_meals_middle
(
    id                                int AUTO_INCREMENT primary key,
    class_id                          int not null comment '班级',
    consumption_category              enum ('早','午','晚'),
